        ...
        <section id="training" className="min-h-screen py-16 px-8 bg-white flex items-center">
            <div className="max-w-6xl mx-auto w-full relative">
                ...
                <div className="relative">
                    <Carousel
                        opts={{
                            align: "start", // Show 3 at a time, left-aligned
                            loop: false,
                        }}
                    ...
                    >
                        <CarouselContent>
                            {trainings.map((training, index) => (
                                ...
                                >
                                    <div className="group relative border-3 border-black bg-white p-6 shadow-[6px_6px_0px_0px_#000] rounded-xl transition-all duration-300 hover:shadow-[10px_10px_0px_0px_#000] h-[420px] flex flex-col">
                                        ...
                                        {/* Inner border */}
                                        <div className="border-2 border-black p-4 bg-gradient-to-br from-white to-gray-50 rounded-lg flex flex-col flex-1">
                                        ...
                                        <div className="absolute inset-2 border border-black opacity-20 pointer-events-none rounded-xl"></div>
                                        <div className="absolute inset-3 border border-black opacity-10 pointer-events-none rounded-xl"></div>
                                    </div>
                                </CarouselItem>
                            ))}
                        </CarouselContent>
